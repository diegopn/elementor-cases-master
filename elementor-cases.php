<?php
/**
 * Elementor Cases WordPress Plugin
 *
...
define( 'ELEMENTOR_CASES', __FILE__ );

/**
 * Include the Elementor_Cases class.
 */
require plugin_dir_path( ELEMENTOR_CASES ) . 'class-elementor-cases.php';
