...
/**
 * Main Elementor Cases Class
 *
 * The init class that runs the Elementor Cases plugin.
...
final class Elementor_Cases {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-cases' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_CASES ) );
